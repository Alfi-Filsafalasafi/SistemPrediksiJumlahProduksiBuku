    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <p><b>Petunjuk:</b></p>
                <ul>
                    <li>Tambahkan data buku dan data produksi baru atau gunakan data buku beserta 
                        data produksinya yang telah ada sebelum melakukan tambah prediksi.</li>
            ...
            <div class="card-footer">
                Di buat oleh Kelompok 2 S1 PTI 2020 A
            </div>
        </div>
    </section>
</div>
